...
var s3Bucket = 'khphoto.image';
var sqsQueueUrl = 'https://sqs.ap-northeast-2.amazonaws.com/936777008077/kh-queue';
var rdsEndpoint = {
  host: 'kh-mysql.cpz602x20cvt.ap-northeast-2.rds.amazonaws.com',
  port: 3306
};

// MySQL DB 이름, 계정, 암호
var sequelize = new Sequelize('khphoto', 'admin', 'kkh4790!', {
